...
Route::group(['middleware' => 'api'], function () {
    ...
    // Rutas para CRUD
    Route::apiResource('competencias','CompetenciaController');
    Route::apiResource('duracion_resultados','DuracionResultadoController');
    Route::apiResource('fichas','FichaController');
    Route::apiResource('niveles_formacion','NivelFormacionController',['parameters'=>['niveles_formacion'=>'nivelFormacion']]);
    Route::apiResource('programas','ProgramaController');
    Route::get('programas/{programa}/competencias','ProgramaController@competencias');
    Route::put('programas/{programa}/competencias','ProgramaController@updateCompetencias');
    Route::apiResource('redes','RedController',['parameters'=>['redes'=>'red']]);
    Route::apiResource('resultados','ResultadoController');
